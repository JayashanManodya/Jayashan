...
export function Contact() {
  ...
  return <Section id="contact">
    <div className="grid md:grid-cols-2 gap-12 lg:gap-24">
      <div>
        ...
        <div className="space-y-6">
          <a href="mailto:kpjmp28@gmail.com" className="flex items-center text-gray-300 hover:text-cyan-400 transition-colors">
            <div className="p-3 rounded-lg bg-white/5 mr-4">
              <Mail className="w-6 h-6" />
            </div>
            <div>
              <p className="text-sm text-gray-500">Email</p>
              <p className="font-medium">kpjmp28@gmail.com</p>
            </div>
          </a>
            ...
            <div className="flex gap-4">
              {socialLinks.map(({ Icon, href }, i) => (
                <a
                  ...
                  className="p-3 rounded-lg bg-white/5 text-gray-400 hover:bg-cyan-500 hover:text-black hover:shadow-[0_0_15px_rgba(0,217,255,0.4)] transition-all duration-300"
                >
    ...
    <footer className="mt-24 pt-8 border-t border-white/10 text-center text-gray-500 text-sm">
      <p>© 2025 Jayashan Manodya. All rights reserved.</p>
    </footer>
  </Section>;
}