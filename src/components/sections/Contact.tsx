  ...
  return (
    <Section id="contact" className="bg-white">
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-4 tracking-tighter">Let's Connect</h2>
      ...
      <div className="grid lg:grid-cols-2 gap-16 lg:gap-32 items-start">
        ...
        >
          ...
          <div className="space-y-8">
            <a href="mailto:kpjmp28@gmail.com" className="group flex items-center p-6 rounded-[32px] bg-slate-50 border border-slate-100 hover:border-[#6366f1]/30 hover:shadow-xl hover:shadow-[#6366f1]/5 transition-all duration-300">
              ...
              <div>
                <p className="text-xs font-black tracking-widest text-slate-400 mb-1">Email Me</p>
            ...
            <div className="pt-8">
              <p className="text-xs font-black tracking-widest text-slate-400 mb-6 ml-1">
                Social Media
              </p>
        ...
        >
          ...
          <Button className="w-full bg-[#6366f1] hover:bg-indigo-700 text-white py-6 rounded-[24px] text-lg font-black tracking-widest shadow-lg shadow-[#6366f1]/20" size="lg">
            Send Message
          </Button>
        </motion.form>
      </div>
      ...
      <footer className="mt-32 pt-12 border-t border-slate-100 text-center">
        <p className="text-slate-400 font-bold tracking-widest text-xs">© 2025 Jayashan Manodya. All rights reserved.</p>
      </footer>
    </Section>
  );
}