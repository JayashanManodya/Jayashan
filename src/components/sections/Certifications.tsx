            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {certifications.map((cert, index) => (
                    <motion.div
                        ...
                        whileHover={{ y: -10 }}
                        className="bg-white dark:bg-slate-900/50 p-8 rounded-[40px] shadow-sm hover:shadow-2xl hover:shadow-indigo-500/10 transition-all border border-slate-200 dark:border-slate-800 group flex flex-col"
                    >
                        <div className="w-16 h-16 bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl flex items-center justify-center mb-6 border border-indigo-100/50 dark:border-indigo-900/40 group-hover:bg-[#6366f1] group-hover:text-white transition-all duration-300">
