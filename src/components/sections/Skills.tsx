  ...
  return (
    <Section id="skills" className="transition-colors duration-300">
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-bold text-black dark:text-white mb-4 tracking-tight">Skills</h2>
        <div className="h-2 w-24 bg-brand-primary mx-auto rounded-full" />
        <p className="text-black/60 dark:text-white/60 max-w-2xl mx-auto mt-8 font-normal leading-relaxed">
