  ...
  return (
    <Section id="about" className="bg-white dark:bg-[#030014] transition-colors duration-300">
      <div className="text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-4 tracking-tighter">About Me</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {interests.map((item, idx) => (
            ...
            >
              ...
              <p className="text-sm text-slate-500 dark:text-slate-400 font-medium leading-snug">{item.desc}</p>
            </motion.div>
          ))}
        </div>
      </div>
