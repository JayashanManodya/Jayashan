    ...
    return (
        <Section id="experience" className="bg-white">
            <div className="text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-4 italic uppercase tracking-tighter">Experience</h2>
                    ...
                    >
                        ...
                        <div className="bg-white p-8 rounded-[32px] border border-slate-50 shadow-sm hover:shadow-xl transition-all duration-300">
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                                <h3 className="text-2xl font-black text-slate-900 italic uppercase tracking-tight">{exp.title}</h3>
                                <span className="text-[#6366f1] font-black text-sm bg-indigo-50 px-4 py-2 rounded-full italic uppercase tracking-wider">{exp.period}</span>
                            </div>
                            <p className="text-lg font-black text-[#6366f1] italic uppercase tracking-widest flex items-center gap-2 mb-4">
