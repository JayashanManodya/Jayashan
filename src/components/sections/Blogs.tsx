    ...
    return (
        <Section id="blogs" className="transition-colors duration-300">
            <div className="text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-bold text-black dark:text-white mb-4 tracking-tight">Blogs</h2>
                <div className="h-2 w-24 bg-brand-primary mx-auto rounded-full" />
                <p className="mt-6 text-black/70 dark:text-white/70 max-w-2xl mx-auto text-lg leading-relaxed">
            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <motion.div
                    ...
                    className="relative rounded-[32px] overflow-hidden bg-white dark:bg-black/[0.06] border border-black/15 dark:border-white/15 shadow-sm hover:shadow-xl transition-all duration-300 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 group"
                >
                    <div className="flex-1">
                        ...
                        <p className="text-black/70 dark:text-white/70 text-lg max-w-xl mb-0">
                    ...
                    <div className="flex-shrink-0">
                        <Button
                            size="lg"
                            className="bg-brand-primary hover:bg-brand-primary-hover text-black border border-black rounded-full px-8 py-6 text-lg transition-all duration-300 shadow-[0_0_20px_var(--brand-primary-glow)] group-hover:scale-105 active:scale-95"
