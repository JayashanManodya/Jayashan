...
-  **Tech Stack:**
    ...
    - **Icons:** Lucide React
    - **Backend/API:** Node.js (Vite environment), Resend API
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/JayashanManodya/Jayashan.git
   cd Jayashan
   ```
...
3. **Set up Environment Variables:**
   Create a `.env` file in the root directory (optional, if using Resend/API features):
   ```env
...
```text
/
├── api/             # Backend/API handlers (Resend integration)
...
│   ├── theme/       # Global theme configurations
